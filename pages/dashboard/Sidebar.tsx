...
>
  ...
  return (
    <Link
      key={i}
      href={item.href}
      className="group relative flex items-center gap-3 p-2 rounded-lg hover:bg-gray-300 cursor-pointer"
    >
...
{system.map((item, i) => {
  ...
  return (
    <Link
      key={i}
      href={item.href}
      className="group relative flex items-center gap-3 p-2 rounded-lg hover:bg-gray-300"
    >
