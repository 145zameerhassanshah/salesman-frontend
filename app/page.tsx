...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      */}
      <div className="h-screen flex flex-col lg:flex-row bg-[#d7dbd9] overflow-hidden">
        ...
        */}
        <div className="order-2 lg:order-1 w-full lg:w-1/2 h-[45vw] lg:h-full relative flex-shrink-0">
          <Image
            src="/images/login4.jpeg"
